    ...
    <div class="main-content">
        ...
        <div class="goods">
            <div>
                ...
                <div class="goods-picture"><img class="product-img" src="img/<?=$good[0]['img'];?>" alt="<?=$good[0]['img'];?>"></div>

                <a href="../models/cart.php?id=<?=$good[0]["id"]?>&action=buy" class="btn buy">Купить</a>
