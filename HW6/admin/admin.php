    ...
    <?php
        if (isset($_GET["action"])){
            ...
            <form method="post" action="edit_goods.php?action=add" enctype="multipart/form-data">
                ...
                <h3>О товаре</h3>
                <textarea required name="description" cols="100" rows="10" placeholder="Введите описание товара"></textarea>
        ...
        elseif (isset($_GET["id"])) {
            ...
            <form method="post" action="edit_goods.php?action=edit&id=<?=$id?>" enctype="multipart/form-data">
                ...
                <p>Изображение</p>
                <div class="goods-picture"><img style="max-width: 200px" src="../public/img/<?=$good[0]['img'];?>" alt="<?=$good[0]['img'];?>"></div>
                <p>Загрузить новую картинку</p>
                <input type="file" name="photo" accept="image/jpeg, image/png, image/gif">
                <h3>О товаре</h3>
            ...
            <a style="display: inline-block; margin: 5px 20px;padding: 8px;color: white; background-color: green; text-decoration: none" href="admin.php?action=add">Добавить товар</a>
            <?php
